...
productRoute.post('/create', verifyAccessToken, authMiddlewareController.verifyTokenAdmin, productController.createNewProduct, sizeController.createSizeDetail, colorController.createColorDetail)
// DELETE: /api/v1/product/delete
productRoute.delete('/delete', verifyAccessToken, authMiddlewareController.verifyTokenAdmin, sizeController.deleteSizeDetailByProductId, colorController.deleteColorDetailByProductId, productController.deleteProduct)
// GET: /api/v1/product/id
productRoute.get('/id', productController.getProductById)
// POST: /api/v1/product/update
productRoute.post('/update', verifyAccessToken, authMiddlewareController.verifyTokenAdmin, productController.updateProduct, sizeController.changeSizeDetailByProductId, colorController.changeColorDetailByProductId)
// GET: /api/v1/product/count
productRoute.get('/count', verifyAccessToken, authMiddlewareController.verifyTokenAdmin, productController.getCountProducts)
// POST: /api/v1/product/image/change
productRoute.post('/image/change', verifyAccessToken, authMiddlewareController.verifyTokenAdmin, productController.changeImageProduct) 
